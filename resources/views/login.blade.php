          ...
          <div class="col-12 col-sm-5 col-md-5 col-lg-5 col-xl-4 h-50 ">
            <div class="card shadow">
              <div class="card-body mx-auto">
                <h4 class="card-title mt-3 mb-3 text-center montserrat">Masuk</h4>
                @if ($errors->any())
                ...
                <form action="api/login">
                  ...
                  <div class="mb-3 input-group">
                    ...
                    <input name="password" type="password" class="form-control" placeholder="Kata sandi" autocomplete="current-password">
                ...
                <p class="text-center">Belum punya akun?
                  <a class="link-primary" href="register">Buat Akun</a>
                </p>
              </div>
            </div>
          </div>
