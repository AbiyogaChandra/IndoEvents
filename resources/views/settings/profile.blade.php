                ...
                <div class="card">
                    <div class="card-body">
                        <nav class="nav flex-column nav-pills nav-gap-y-1">
                            <a href="{{ route('settings.profile') }}" id="profile-tab" class="nav-item nav-link has-icon nav-link-faded active">
                    ...
                    <div class="card-header border-bottom mb-3 d-flex d-md-none" role="navigation">
                        <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('settings.profile') }}" id="profile-tab" class="nav-link has-icon active"><svg
